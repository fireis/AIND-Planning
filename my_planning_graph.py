...
class PlanningGraph():
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        """
        disjoint = not(set(node_a1.action.effect_add).isdisjoint(node_a2.action.effect_rem) and
                       set(node_a2.action.effect_add).isdisjoint(node_a1.action.effect_rem))
        return (disjoint)
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        """
        interf = not (set(node_a1.action.precond_pos).isdisjoint(node_a2.action.effect_rem) and
                set(node_a2.action.precond_pos).isdisjoint(node_a1.action.effect_rem))
        return interf
    ...
    def negation_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s) -> bool:
        ...
        :return: bool
        """
        eq = node_s1.symbol == node_s2.symbol
        diff = node_s1.is_pos != node_s2.is_pos
        return eq and diff
